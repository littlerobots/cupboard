...
import nl.qbusict.cupboard.convert.AnnotatedConverterFactory;

/*
 * Variant that handles the use of Annotations that allows one to decouple a field
...
public final class AnnotatedCupboardFactory {
    private static Cupboard INSTANCE = new Cupboard(new AnnotatedConverterFactory());
